	...
	<c:if test="${sessionScope.suid != null }">
		...
		<div class="col-lg-8">
			...
			<tr>
				...
				<%-- <%-- <input class="btn btn-default" type="button" value="삭제" onclick="location.href='pdsDelete.jsp?pdsno=<%=pdsno%>'">
				<input  class="btn btn-default" type="button" value="수정" onclick="location.href='pdsUpdate.jsp?pdsno=<%=pdsno%>&filename=<%=dto.getFilename()%>'">
				<button  class="btn btn-default" type="button" onclick="location.href='pdsList.jsp'">목록</button> --%>
