...
<%@ include file="../header.jsp" %>
	...
	<div class="mp_sidenav">
   	...
   	<div class="mp_main">
	   	<h3 style="padding-left: 37%">문의사항 답변 입력</h3>
		<div class="container">
	  		<form class="form-horizontal" name="inquiryForm" action="inquiry_replyproc.do" method="post" onsubmit="return inuqiryCheck(this)">
